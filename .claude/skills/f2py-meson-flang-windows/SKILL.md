...
| `unexpected array size: new_size=1, got array with arr_size=0` | zero-size array passed to an f2py-wrapped routine (dimension-owning sizes collapse oddly) | guard empty batches on the Python side before the call |
